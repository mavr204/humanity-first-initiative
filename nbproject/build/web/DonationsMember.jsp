<%@ page import="java.util.List, UserLogin.Payment" %>
        ...
        <main class="d-flex">
            ...
            <div class="d-flex flex-column flex-shrink-0 bg-col side-bar" id="side-bar">
                <ul class="nav nav-pills nav-flush flex-column mb-auto">
                  ...
                  <li id="sb-icon-2">
                    <a href="Dashboard" class="nav-link py-3 border-bottom side-bar-sm-links" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard" aria-current="page">
                      <img src="Images/dashboard-icon-2.png" title="Dashboard" class="side-bar-sm-icons">
                    </a>
                  </li>
                  <li id="sb-icon-3">
                    <a href="Donations" class="nav-link py-3 border-bottom activa side-bar-sm-links" title="Donations" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                ...
                <div class="dropdown border-top-m">
                  <a class="d-flex align-items-center justify-content-center text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="content-wrapper">
                ...
                <div class="col-lg d-flex align-items-center">
                        <img src="Images/dash.png" class="dash-img" title="Donations">
                        <h3 class="dash-text">Donations</h3>
                </div>
                <!-- card row 1 -->
                            ...
                            <thead>
                                ...
                                <%
                                    ...
                                    for(Payment payment : payments){
                                        ...
                                        out.println("<td>" + payment.getTransactionId() + "</td>");
