<%-- 
    Document   : SignUppt2
    Created on : Nov 7, 2023, 4:18:23 AM
    Author     : gamer
--%>
...
<html lang="en">
    ...
    <header class="title-bar d-flex justify-content-center align-items-center">
        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div style="padding-left: 1.5vw;">
                <a href="index.html"><img title="Home"
            ...
            <!-- Title  -->
            <div>
                <h1><a class="title-link timesF" href="index.html"> HUMANITY FIRST INITIATIVE </a></h1>
            </div>
            <!-- title button -->
            <span><a type="button" href="LoginA.html" id="sign-out" class="btn btn-outline-light title-btn p22MacF">Sign
                    in</a></span>
        </div>
    </header>
            ...
            <div class="login-side">
                <div class="my-form__wrapper">
                    <div class="login-welcome-row">
                        ...
                        <h6 style="color: red; text-align: center;">The Username is already taken.</h6>
                    </div>
                    <form action="CreateUser" method="post">
                        ...
                        <div class="text-field">
                            ...
                            <input type="text" id="username" name="username" placeholder="Your Username" maxlength="10" minlength="4" required>
                            <img alt="Username Icon" title="Username Icon" src="Images/email.svg">
                        </div>
                        <div class="text-field">
                            <label for="password">Password:</label>
                            <input id="password" value="<%=password%>" type="password" name="password" placeholder="Your Password" title="Minimum 6 characters at 
                                        least 1 Alphabet and 1 Number" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$"
                                required>
                            <img alt="Password Icon" title="Password Icon" src="Images/password.svg">
                        </div>
                        <div class="text-field">
                            <label for="confirm-password">Repeat Password:</label>
                            <input id="confirm-password" value="<%=password%>" type="password" placeholder="Repeat Password"
   ...
   <footer class="container-fluid foot">
    <div class="block-pad">
        <div class="row justify-content-between mb-3" id="footer-div">
            <!-- Quick Links -->
            <div class="my-col fit-con">
                ...
                <ul class="nav my-flex-column fit-con">
                    ...
                    <li class="fit-con"><a href="SignUppt1A.html" class="foot-link">Join Us</a></li>
                    <li class="fit-con"><a href="./privacyPolicy.html" class="foot-link">Privacy Policies</a></li>
                </ul>
            </div>
            ...
            <div class="my-col fit-con">
                <ul class="nav my-flex-column align-items-center" style="line-height: 1.3vw;">
                    ...
                    <li class="fit-con nav-item"><a style="font-size: 1vw;"
                            class="foot-link"><em>+91-7439272165</em></a></li>
                    <li class="fit-con nav-item">
                        <h4 class="foot-headings p22MacF" style="font-size: 1.5vw;">Email</h4>
                    </li>
                    <li class="fit-con nav-item"><a href="mailto:humanityfirstinitiative.org@gmail.com"
                            style="font-size: 1vw;"
                            class=" foot-link cascadiaF">humanityfirstinitiative.org@gmail.com</a>
                    </li>
                    <li></li>
                </ul>
            </div>
            ...
            <div class="col-lg" id="nsltr">
                <form action="Newsletter" method="post" id="nsltr-form" target="_blank">
                    ...
                    <div id="emailSubmitted" class="d-none" style="color: green">Email Successfully submitted!</div>
        ...
        <div class="flex-column justify-content-center border-top-m pt-2">
            <div>
                <p class="foot-headings footer-note soraRegularF">© 2022 HFI Org. All rights reserved.</p>
            </div>
            <div>
                <ul class="list-unstyled d-flex justify-content-center mb-0">
                    <li class="ms-3"><a class="link-dark" href="#"><img src="Images/X-logo.png" alt="@Username"
                                title="Twitter" style="width: 2.5vw"></a></li>
                    <li class="ms-3"><a class="link-dark" href="#"><img src="Images/fb-logo.png" alt="Page Name"
                                title="Facebook" style="width: 2.5vw"></a></li>
                    <li class="ms-3"><a class="link-dark" href="#"><img src="Images/Insta-logo.png" alt="Page Name"
                                title="Instagram" style="width: 2.5vw"></a></li>
                </ul>
            </div>
        </div>
    </div>
