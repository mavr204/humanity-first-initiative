        ...
        <div class="login-side">
            <div class="my-form__wrapper">
                <div class="login-welcome-row">
                    ...
                    <h6 style="color: red; text-align: center;">Wrong Email or Password</h6>
                </div>
                <form action="UserValidation" method="post">
                    ...
                    <div class="text-field">
                        ...
                        <input type="text" id="username" value="<%=username%>" name="username" placeholder="Your Username" maxlength="10" minlength="4" required>
                    ...
                    <div class="my-form__actions">
                        <div class="my-form__row">
                            ...
                            <a href="ResetPasswordA.html" title="Forgotten Password">
                                Forgotten Password
                            </a>
                        </div>
                        <div class="my-form__signup">
                            <a href="SignUppt1A.html" title="Create Account">
                                Create Account
                            </a>
                        </div>
                    </div>
